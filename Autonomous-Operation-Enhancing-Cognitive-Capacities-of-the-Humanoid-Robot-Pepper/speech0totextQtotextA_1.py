...
if __name__ == "__main__":
    ...
    while True:
        ...
        if user_question:
            ...
            print('Utilisation caméra : ' , JAWAB)
            with open('cam.txt', "w") as file:
                file.write(JAWAB)
                
            print('Personne se présente : ' , jawab)
            
            with open('pres.txt', "w") as file:
                file.write(jawab)
                
            print('Personne demande est-ce que tu le connais ou pas : ' , jaWaB)
